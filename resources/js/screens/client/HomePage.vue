<template>
   <div>
      ...
      <v-img stlyle="width:100%;" src="https://tesla-cdn.thron.com/delivery/public/image/tesla/2ddb3f38-d056-43cc-8e35-c849e7817ded/bvlatuR/std/2880x1800/MX-Interior-Hero-Desktop"></v-img>
      <div style="background-color:black;margin-top:-10px">
        <div fluid class="background" style="display:table">
            <div style="display:table-cell;vertical-align:bottom;padding-buttom:50px">
                <v-row>
                    <v-col>
                    ...
                    <v-col>
                        ...
                        <p class="white--text">0-60 mphs</p>
                    </v-col>
                </v-row>
            </div>
        </div>
...
<style>
 ...
 .background {
    background: url('/assets/MX-Performance-Hero-Desktop.jpg');
    background-size: cover;
    width: 100%;
    height: 90vh;
 }
